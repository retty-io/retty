...
/// # Note
///
/// This type wraps the inner `std` variant and is used to align the retty-io
...
impl Instant {
    ...
    /// Create a `retty_io::time::Instant` from a `std::time::Instant`.
    ...
    ///
    /// ```
    /// use retty_io::time::{sleep, Duration, Instant};
    ///
